  ...
  return (
    <div id="createCompDiv">
      ...
      <form aria-label="form" onSubmit={handleFormSubmit}>
        ...
        <div>
          <input id = "units" type="text" name="units" id="units" placeholder="Unit of Measurement" onClick={openFrequencyHelp} required />
